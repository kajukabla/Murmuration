...
fn flock(@builtin(global_invocation_id) id: vec3u) {
  ...
  var nearest_d2: array<f32, 10>;   // distances squared
  var nearest_pos: array<vec3f, 10>; // cached positions
  var nearest_vel: array<vec3f, 10>; // cached velocities
  var n_found = 0u;
